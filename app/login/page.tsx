      ...
      <div style={{ width: 360, background: "var(--color-background-primary)", border: "0.5px solid var(--color-border-tertiary)", borderRadius: "var(--border-radius-xl)", padding: 32, display: "flex", flexDirection: "column", gap: 20 }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
            <i className="ti ti-layout-dashboard" style={{ fontSize: 22, color: "#7F77DD" }} />
            <span style={{ fontSize: 16, fontWeight: 600, color: "var(--color-text-primary)" }}>Productivity</span>
          </div>
          <h1 style={{ fontSize: 20, fontWeight: 600, color: "var(--color-text-primary)", marginBottom: 4 }}>Connexion</h1>
          <p style={{ fontSize: 13, color: "var(--color-text-secondary)" }}>Bienvenue sur AppTrack</p>
        </div>
        ...
        <p style={{ fontSize: 12, color: "var(--color-text-secondary)", textAlign: "center" }}>
          ...
          <Link href="/register" style={{ color: "#7F77DD", textDecoration: "none", fontWeight: 500 }}>Créer un compte</Link>
        </p>
      </div>
    </div>
  );
