      ...
      >
          ...
          <div>
            ...
            <input
              ...
              onFocus={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 0 0 2px #D85A3033";
              }}
              onBlur={(e) => {
              ...
              {PRIORITY_OPTIONS.map((opt) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      padding: "5px 12px",
                      border: sel ? `1px solid ${opt.color}` : "0.5px solid var(--color-border-tertiary)",
                      borderRadius: 20,
                      fontSize: 12,
                      cursor: "pointer",
              ...
              {STATUS_OPTIONS.map((opt) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      padding: "5px 12px",
                      border: sel ? "1px solid #D85A30" : "0.5px solid var(--color-border-tertiary)",
                      borderRadius: 20,
                      fontSize: 12,
                      cursor: "pointer",
                      background: sel ? "#FAECE7" : "transparent",
                      color: sel ? "#993C1D" : "var(--color-text-secondary)",
                      fontWeight: sel ? 500 : 400,
                      transition: "all 0.1s",
                    }}
                  >
        ...
        >
          ...
          <button
            ...
            style={{
              padding: "6px 14px",
              background: title.trim() ? "#D85A30" : "var(--color-border-tertiary)",
